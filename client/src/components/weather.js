...
class Weather extends Component{
	...
	componentWillMount() {
		...
		this.props.getWeatherFromIP(this.state.units,()=>this.setState({forecast:true}));
    ...
    convertTemps(){
        console.log('eggs');
        // this.setState({units:this.state.units==='imperical'?this.state.units==='metric':this.state.units==='imperial'})
			...
			return (
				...
				<div>
                    ...
                    <div className = "dataButtons">
                        <button className={this.state.temperature?"selected":''} onClick={()=>this.chooseDisplay("temperature")}>Temperature</button>
